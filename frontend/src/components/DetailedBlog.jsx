...
export default function DetailedBlog({ id }) {
  ...
  Moment.locale("en");
  return (
    <div className="flex flex-column align-items-center pt-3 pb-16 lg:pt-16 lg:pb-24  dark:bg-gray-900">
      {blog && (
        <div className="mx-auto w-full max-w-2xl format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
          ...
          <div className="flex justify-between">
            ...
            <div className="flex gap-4 align-items-center">
              ...
              <button className="px-3 py-2 text-xs font-medium text-center text-white bg-red-700 rounded-lg hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">
                Delete
              </button>
            </div>
          </div>
